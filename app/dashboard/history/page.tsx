...
export default function HistoryPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <PaymentTable payments={payments} isLoading={isLoading} filters={filters} onSort={(sortBy) => patch({ sortBy, sortDir: filters.sortBy === sortBy && filters.sortDir === "asc" ? "desc" : "asc" })} onAdd={openAddPayment} onEdit={setEditing} onReceipt={setReceipt} onDelete={setDeleting} />
